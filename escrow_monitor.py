...
<head>
  ...
  <style>
    ...
    * {{ margin: 0; padding: 0; box-sizing: border-box; }}
    ...
    .card-value.bloqueado {{ color: var(--vermelho); }}
    .card-value.desbloqueado {{ color: var(--verde); }}
    .card-value.transferido {{ color: var(--azul); }}
    .card-value.saldo {{
...
<body>
  <header class="header">
    <div class="header-left">
      ...
      <div>
        ...
        <span class="subtitle">Bloqueios Judiciais — CA$A$ BAHIA I</span>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="cards">
      <div class="card">
        <div class="card-label">Total Bloqueado</div>
